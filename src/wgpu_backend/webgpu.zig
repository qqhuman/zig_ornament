...
pub const DepthStencilState = extern struct {
    next_in_chain: ?*const ChainedStruct = null,
    format: TextureFormat,
    depth_write_enabled: Bool = Bool.false,
...
pub const SurfaceCapabilities = extern struct {
    ...
    alpha_modes: ?[*]const AlphaMode = null,
};
...
pub const ComputePassEncoder = *opaque {
    ...
    pub inline fn beginPipelineStatisticsQuery(
        compute_pass_encoder: ComputePassEncoder,
        query_set: QuerySet,
        query_index: u32,
    ) void {
        wgpuComputePassEncoderBeginPipelineStatisticsQuery(compute_pass_encoder, query_set, query_index);
    }
    ...
    pub inline fn endPipelineStatisticsQuery(
        compute_pass_encoder: ComputePassEncoder,
    ) void {
        wgpuComputePassEncoderEndPipelineStatisticsQuery(compute_pass_encoder);
    }
...
pub const RenderPassEncoder = *opaque {
    ...
    pub inline fn beginPipelineStatisticsQuery(
        ...
        wgpuRenderPassEncoderBeginPipelineStatisticsQuery(render_pass_encoder, query_set, query_index);
    }
...
pub const Surface = *opaque {
    pub inline fn configure(surface: Surface, config: *const SurfaceConfiguration) void {
    ...
    pub inline fn getCurrentTexture(surface: Surface) SurfaceTexture {
        var surfaceTexture: SurfaceTexture = undefined;
        wgpuSurfaceGetCurrentTexture(surface, &surfaceTexture);
        return surfaceTexture;
    }
    extern fn wgpuSurfaceGetCurrentTexture(surface: Surface, surfaceTexture: *SurfaceTexture) void;

    pub inline fn getPreferredFormat(surface: Surface, adapter: Adapter) TextureFormat {
    ...
    pub inline fn present(surface: Surface) void {
        wgpuSurfacePresent(surface);
    }
    extern fn wgpuSurfacePresent(surface: Surface) void;

    pub inline fn unconfigure(surface: Surface) void {
