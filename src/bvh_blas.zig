...
pub const BvhBlas = struct {
    ...
    normals: *gpu_structs.ArrayList(gpu_structs.Normal),
    normal_indices: *gpu_structs.ArrayList(u32),
    uvs: *gpu_structs.ArrayList(gpu_structs.Uv),
    uv_indices: *gpu_structs.ArrayList(u32),
    ...
    pub fn remove(self: *Self, mesh: *Mesh) void {
