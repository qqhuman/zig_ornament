...
pub const BvhTlas = struct {
    const Self = @This();
    nodes: *gpu_structs.ArrayList(gpu_structs.Node),
    transforms: *gpu_structs.ArrayList(gpu_structs.Transform),
            ...
            switch (leafs[0]) {
                .sphere => |s| {
                    ...
                    return .{
                        ...
                        .right_or_material_index = try getMaterialIndex(s.material),
                ...
                .mesh => |m| {
                    ...
                    return .{
                        ...
                        .right_or_material_index = try getMaterialIndex(m.material),
                ...
                .mesh_instance => |mi| {
                    ...
                    return .{
                        ...
                        .right_or_material_index = try getMaterialIndex(mi.material),
                        .node_type = gpu_structs.NodeType.Mesh,
                        .transform_id = @as(u32, @truncate(transform_id)),
    ...
    fn getMaterialIndex(material: *Material) !u32 {
        _ = material;
    }
};
